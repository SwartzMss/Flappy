...
impl State{
    fn new() -> Self {
        State {
            ...
            obstacles: vec![
                ...
                Obstacle::new(SCREEN_WIDTH + 40, 0),  // 第二个障碍物初始位置更远
            ],
            score: 0,
        }
    }
    ...
    fn restart(&mut self) {
        ...
        self.obstacles = vec![
            Obstacle::new(SCREEN_WIDTH, 0),
            Obstacle::new(SCREEN_WIDTH + 40, 0),
        ];
        self.score = 0;
    }
    ...
    fn main_menu(& mut self, ctx: &mut BTerm){
        ctx.cls();
        ctx.print_centered(18, "Welcome to Flappy Game");
    ...
    fn dead(&mut self, ctx: &mut BTerm){
        ctx.cls();
        ctx.print_centered(18, &format!("You are already dead ,score = {}",self.score));
        ctx.print_centered(20, "(P) Play Game");
        ctx.print_centered(21, "(Q) Quit Game");
